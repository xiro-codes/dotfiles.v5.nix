...
pkgs.writeShellScriptBin "serve-docs" ''
  ...
  ln -s "${self.packages.x86_64-linux.docs-generated}/README.md" "$BOOK_DIR/src/modules.md"
  ln -s "${self.packages.x86_64-linux.docs-generated}/system-modules.md" "$BOOK_DIR/src/system-modules.md"
  ln -s "${self.packages.x86_64-linux.docs-generated}/home-modules.md" "$BOOK_DIR/src/home-modules.md"
